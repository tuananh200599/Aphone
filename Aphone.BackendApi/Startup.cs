...
namespace Aphone.BackendApi
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<AphoneDbContext>(options =>
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Swagger Aphone", Version = "v1" });
